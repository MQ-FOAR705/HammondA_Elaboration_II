...
\result{Conversion was successful and created a 98mb doc file. The file had readable contents. I copied the contents into a .TXT file and saved it successfully for further analysis}
...
\result{The analysis provided was equipped with word clouds, graphs and various means to identify themes throughout the sources.}
\
\section*{Conclusion}
